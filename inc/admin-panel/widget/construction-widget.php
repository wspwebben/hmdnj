...
function construction_lite_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($construction_lite_widgets_field_type) {
        ...
        case 'text' : ?>
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($construction_lite_widgets_name)); ?>"><?php echo esc_html($construction_lite_widgets_title); ?>:</label>
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($construction_lite_widgets_name)); ?>"><?php echo esc_html($construction_lite_widgets_title); ?>:</label><br />
