                    ...
                    <div class="team-members wow fadeInUp">
                        ...
                        <div class="team-sub-wrap">
                            <div class="member-name-designation-social">
                                ...
                                <?php if($construction_lite_member_designatoin){ ?><div class="member-designation"><?php echo esc_html($construction_lite_member_designatoin); ?></div><?php } ?>
                            ...
                            <?php if(get_the_content()){ ?><div class="member-description"><?php echo esc_html(wp_trim_words(get_the_content(),'20','...')); ?></div><?php } ?>
                        </div>
                    </div>
            <?php
                }
