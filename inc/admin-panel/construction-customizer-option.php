...
//Post Settings
$wp_customize->add_section(
    'construction_lite_post_section',
    array(
        'title' => __('Post Settings','construction-lite'),
        'priority' => 3,
        // 'panel' => 'construction_lite_home_panel',
        'capability' => 'edit_theme_options',
    )
...
/** Feature Image **/
$wp_customize->add_setting(
'construction_lite_feature_img_enable',
array(
    'default' => 1,
    'sanitize_callback' => 'construction_lite_sanitize_checkbox'
)
...
'construction_lite_feature_img_enable',
array(
    'label' => __('Check Enable Feature Menu','construction-lite'),
    'priority' => 10,
    'type' => 'checkbox',
    'section' => 'construction_lite_post_section'
)
);

/** Author **/
$wp_customize->add_setting(
'construction_lite_post_authr_enable',
array(
    'default' => 1,
    'sanitize_callback' => 'construction_lite_sanitize_checkbox'
)
...
'construction_lite_post_authr_enable',
array(
    'label' => __('Check Enable Post Author','construction-lite'),
    'priority' => 20,
    'type' => 'checkbox',
    'section' => 'construction_lite_post_section'
)
...
/** Date **/
$wp_customize->add_setting(
'construction_lite_post_date_enable',
array(
    'default' => 1,
    'sanitize_callback' => 'construction_lite_sanitize_checkbox'
)
...
'construction_lite_post_date_enable',
array(
    'label' => __('Check Enable Post Date','construction-lite'),
    'priority' => 30,
    'type' => 'checkbox',
    'section' => 'construction_lite_post_section'
)
...
/** Comments **/
$wp_customize->add_setting(
'construction_lite_post_comments_enable',
array(
    'default' => 1,
    'sanitize_callback' => 'construction_lite_sanitize_checkbox'
)
...
'construction_lite_post_comments_enable',
array(
    'label' => __('Check Enable Post Comments','construction-lite'),
    'priority' => 30,
    'type' => 'checkbox',
    'section' => 'construction_lite_post_section'
)
