	...
	class Construction_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Recommended Plugins', 'construction-lite'),
					'demo_import' => esc_html__('Import Demo', 'construction-lite'),
					'free_vs_pro' => esc_html__('Free Vs Pro', 'construction-lite'),
					'changelog' => esc_html__('ChangeLog', 'construction-lite'),
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated'])) ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						<h2><?php printf(esc_html__( 'Welcome!', 'construction-lite' )) ?></h2>
						<p class="about-desc"><?php /* translators: %s : Theme Name */ printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'construction-lite' ), $this->theme_name);  ?></p>
						<hr/>
							...
							<div class="apwelcome-column col-demos">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Starter site demos!', 'construction-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got 1 choices of great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'construction-lite' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page#demo_import' ) ) ); ?></p>
								</div>
								<div>
									<div class="button-wrapper">
										<a class="button button-primary button-hero install-now" href="<?php echo esc_url(admin_url( 'themes.php?page=welcome-page#demo_import' )) ?>"><?php esc_html_e( 'ready to use starter sites.', 'construction-lite' ); ?></a>
										<?php printf( wp_kses_post( '<a class="options-page-btn button-secondary" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'construction-lite' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page' ))  ); ?>
									</div>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Documentation', 'construction-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'construction-lite' ), $this->theme_name  ); ?></p>
									<a href="<?php echo esc_url($this->strings['doc_link']);?>" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'construction-lite' ); ?></span></a>
									<a href="<?php echo esc_url('https://accesspressthemes.com/support/')?>" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'construction-lite' ); ?></span></a>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','construction-lite') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'construction-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','construction-lite') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'construction-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w')?>"><?php echo esc_html('Subscribe our YouTube Channel','construction-lite') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'construction-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','construction-lite') ?></a><?php echo esc_html__(' -to stay updated. ', 'construction-lite'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','construction-lite') ?></h4>
											<p><?php /* translators: %s : Theme Name */ printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'construction-lite'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/construction-lite/reviews/#new-post"><?php echo esc_html('Write a review','construction-lite') ?></a>
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'construction-lite');
						}
