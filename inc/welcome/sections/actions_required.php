					...
					<div class="recom-plugin-inner-wrapper">
						<div class="plugin-title-install clearfix">
							...
							<div class="version-author-info free">
								<span class="version"><?php echo esc_html__('Version ', 'construction-lite') . esc_html($plugin['version']); ?></span>
				...
				<div class="recom-plugin-wrap ">
					<div class="recom-plugin-inner-wrap">
						<div class="plugin-title-install clearfix">
							...
							<div class="version-author-info free">
								<span class="version"><?php echo esc_html__('Version ', 'construction-lite') . esc_html($info->version); ?></span>
								<span class="seperator">|</span>
